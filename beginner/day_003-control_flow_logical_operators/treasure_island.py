...
while True:
  ...
  if (direction.lower() == "r" or direction.lower()  == "l" or direction.lower()  == "right" or direction.lower()  == "left"):
    break
  else:
...
#went left
    ...
    #waited for boat
        ...
        while True:
            ...
            if (door.lower() == "r" or door.lower() == "y" or door.lower() == "b" or door.lower() == "red" or door.lower() == "yellow" or door.lower() == "blue"):
                break   
            else:
                print("Invalid input, try again.")
        #chose red
